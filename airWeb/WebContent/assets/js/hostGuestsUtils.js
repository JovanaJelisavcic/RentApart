...
searchedUsers= null;
    //fetch reservations
    $.ajax({
        url: "rest/apartments/getHostGuests",
        type: "GET",
        ...
        success: function(response) {
            if (response.length != 0) {
                ...
                $("#guestsToolbar").append(searchReserv);
                ...
                $(searchReserv).keyup(function() {
                    ...
                    if (filter != "") {
                        nameGuest = null;
                        $("#hostGuests").find(".nearby-user").each(function() {
                ...
                $(titleReserv).text('Your didn\'t have any guests yet');
                $("#guestsToolbar").append(titleReserv);
                $("#guestsToolbar").show();
            }
        },
